								...
								<c:forEach items="${allOrders}" var="o" varStatus="status">
									<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px" width="60%">
												<%-- <input type="button" value="订单详情" id="but${o.oid}" class="myClass" onclick="showDetail('${o.oid}')"/> --%>
												<input type="button" value="订单详情" id="${o.oid}" class="myClass"/>
												<table border="1px" width="100%" id="myTb">
													<!-- <tr>
														<th>商品</th>
														<th>名称</th>
														<th>单价</th>
													...
													<tr>
														<td>
															<img src="/store_v5/products/1/c_0001.jpg" width="50px"/>
														</td>
														<td>XXX</td>
														<td>XXX</td>
														<td>XXX</td>
		...
		$(function(){
			$(".myClass").click(function(){
				...
				if(txt == '订单详情'){
					$.ajax({
						type: "POST",
						url: "/store_v5/AdminOrderServlet",
						data: {method:"findOrderByOidWithAjax", id:id},
						dataType: "json",
