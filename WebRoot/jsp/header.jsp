...
<script>
$(function(){
	//向服务端CategoryServlet__>getAllCats发起ajax请求,服务端经过处理,
	...
	$.post(url,obj,function(data){
		...
		//获取到服务端响应回的数据,经过观察data中存放的是一个JSON格式数组,遍历数组,动态的显示分类区域代码	
		$.each(data,function(i, obj){
			var li="<li><a href='/store_v5/ProductServlet?method=findProductsByCidWithPage&num=1&cid="
